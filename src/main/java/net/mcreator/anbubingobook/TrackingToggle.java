...
public class TrackingToggle extends ElementsAnbubingobookMod.ModElement {
	/**
	 * Do not remove this constructor
	 */
	public TrackingToggle(ElementsAnbubingobookMod instance) {
		super(instance, 12);
	}
    ...
    public static void inversetracking() {
        tracking = !tracking;
    }
