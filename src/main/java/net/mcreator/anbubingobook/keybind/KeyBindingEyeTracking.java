...
package net.mcreator.anbubingobook.keybind;

import net.mcreator.anbubingobook.TrackingToggle;
...
public class KeyBindingEyeTracking extends ElementsAnbubingobookMod.ModElement {
	private KeyBinding keys;
	public KeyBindingEyeTracking(ElementsAnbubingobookMod instance) {
		super(instance, 11);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.eye_tracking", Keyboard.KEY_M, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		TrackingToggle.inversetracking();
	}
