 ...
 *
 *    Keep the ElementsAnbubingobookMod object in this class and all calls to this object
...
public class AnbubingobookMod {
	...
	@Mod.Instance(MODID)
	public static AnbubingobookMod instance;
	public ElementsAnbubingobookMod elements = new ElementsAnbubingobookMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsAnbubingobookMod.GuiHandler());
